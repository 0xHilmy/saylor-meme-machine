        ...
        <div className="bg-white rounded-xl p-8 shadow-md">
          <div className="aspect-square max-w-md mx-auto mb-6 bg-gradient-to-br from-blue-100 to-orange-100 rounded-xl flex items-center justify-center">
            <div className="text-center">
              ...
              <p className="text-gray-600">Meme original dari developer akan segera hadir</p>
            </div>
          </div>
          <p className="text-gray-600">
            Halaman ini akan menampilkan meme-meme original yang dibuat khusus oleh developer.
            Stay tuned untuk konten eksklusif!
          </p>
        </div>
      </div>
    </Layout>
